...
export const Route = createFileRoute("/contact")({
  head: () => ({
    meta: [
      { title: "Contact — CyberSense" },
      { name: "description", content: "Get in touch with the CyberSense team." },
    ],
  }),
  component: Contact,
});
          ...
          <div className="glass rounded-2xl p-6">
            ...
            <div className="flex gap-2">
              {[Github, Twitter, Linkedin].map((Icon, i) => (
                <a key={i} href="#" className="grid h-10 w-10 place-items-center rounded-md glass hover:neon-border transition-all">
